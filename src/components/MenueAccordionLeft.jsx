import { MenueData, MenueDataLeft, } from '@/data/menue';
...
const MenueAccordionLeft = () => {

  return (
    <div className='py-0 md:py-6'>
      <div className="w-full mx-auto mt-8">
        {Object.keys(MenueDataLeft).map(category => (
          <AccordionItem key={category} title={category} items={MenueDataLeft[category]} />
        ))}
      </div>
    </div>
  )
...
export default MenueAccordionLeft